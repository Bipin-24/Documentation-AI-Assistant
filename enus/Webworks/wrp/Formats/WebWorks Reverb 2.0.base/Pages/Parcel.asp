...
<body id="" wwpage:attribute-id="body-id" data-is-parcel="true">
  <!-- TOC -->
  <!--     -->
  <div id="" wwpage:attribute-id="toc-id" wwpage:content="toc">
    Table of Contents.
  </div>

  <!-- Data -->
  <!--      -->
  <div id="" wwpage:attribute-id="data-id">
    <!-- Prev/Next -->
    <!--           -->
    <div wwpage:replace="prev-next">
      Prev/Next.
    </div>

    <!-- Topics -->
    <!--        -->
    <div wwpage:replace="topics">
      Topics.
    </div>
  </div>
